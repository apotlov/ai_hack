...
{i}. Сессия {session_info} - Риск: {case['fraud_probability']:.1%}
   Объяснение: {case['llm_explanation'][:150]}...
...
"""
    if medium_risk_cases > 0:
        detailed_report += f"""
1. Усилить наблюдение за {medium_risk_cases} случаями среднего риска
...
3. Настраивать пороги в зависимости от текущих угроз
